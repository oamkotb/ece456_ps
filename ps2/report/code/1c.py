...
# Lattice data
N = 100 * 10  # Total number of internal lattice points [unitless integer]
n = np.linspace(1, N, N)  # Array of lattice point indices/eigenvalue numbers [unitless]
a = 1e-10 / 10  # Lattice constant or distance between grid points [m]
...
with np.printoptions(precision=3, suppress=True):
    # use eigh rather than eig because optimized for symetrical matrixes
