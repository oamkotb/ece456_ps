...
plt.grid()
plt.title("Fermi Function of Contact 1")
...
plt.ylabel("Energy (eV)")
plt.grid()
plt.title("Fermi Function of Contact 2")
...
plt.ylabel("Energy (eV)")
plt.grid()
plt.title("Difference in Agenda Between Contact 1 and 2")
shade = (f1 - f2 > 0.01) & (E >= -0.1)
plt.fill_betweenx(E, 0, f1 - f2, where=shade, color="g", alpha=0.2)
plt.show()
